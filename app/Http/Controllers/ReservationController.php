...
class ReservationController extends Controller
{
     ...
     public function getOptions()
    {
      ...
      public function Confirm_HCN(Request $request)
        ...
        public function redirectToZoho(Request $request)
        {
            ...
            // Replace with your Zoho Client ID and redirect URI
            $clientID = "1000.YIYUYBX00819NAPR1F7LTNSWLIOKEZ";
    ...
    public function redirectToZoho_purchase(Request $request)
    {
        $data_reservation = $request['data_reservation'];
        // Replace with your Zoho Client ID and redirect URI
        $clientID = "1000.X0VZ0900A06J0IKEZY95BLMSDRPBKK";
        ...
        return redirect("$authorizationUrl?$query")->with($data);
    }
 ...
 public function getAccessToken_purchase(Request $request)
   ...
   public function update(Request $request, Reservation $reservation)
    ...
    function getData_API($data){
      ...
      public  function sale_Purchase_zoho(){
        ...
        $dateFin = $date -> format('Y/m/t');
        // return $dateFin;
            //     $reservations = Reservation::limit(60)

            
            // ->join('hotellists', 'reservations.hotelCode', '=', 'hotellists.Hotel_Code')
            //       ->whereDate('bookingDate','<=',$date2 )
            //       ->whereDate('bookingDate','>=', $date1)
            //      ->where('reservations.status','=',"OK")
            //       ->ORwhere('reservations.status','=',"CN")
            //   ->where('reservations.sellingPrice_amount','!=',0)
            //      ->orderBy('bookingDate','DESC')
            //      ->select('*','hotellists.provider  as providerName','reservations.provider  as provider_h','hotellists.Hotel_Name as Hotel_Name_h')
        ...
        $reservationsapis_booking = Reservation::
        whereDate('bookingDate','=',$dateapi )
        // where('tgx','FCPWJ')
        ->get();
        $reservationsapis_checkout = Reservation::
        whereDate('checkoutDate','=',$dateapi )
        ->get();
        //   $reservation_alls=Reservation::
        //         whereDate('bookingDate','>=','2022-11-03')
        //         ->where('quoteSelling_booking',0)
        //         ->get();
       ...
       return view('sale_purchase')->with($data); 
      }
      //////////////////////////////////////////////////////////API
      
    public  function Purchase_zoho(){
            ...
            return view('sale_purchase_zoho')->with($data); 
    }
}