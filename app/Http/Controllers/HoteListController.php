...
use App\Models\Hotelvervotech;
use App\Models\Hotelmapping;
use App\Models\Hotelmapping_V01;
...
class HoteListController extends Controller
{
    ...
    public function liste()
    {
        ...
        $hotels = Hotelvervotech::limit(1000)->get();
        $agency = Agencycontact::
        where('Contact_Type','SELLER')->get();
        $countries = Country::all();
    
        return view('admin.vervotech.index',['countries'=>$countries,'agency'=>$agency,'hotels'=>$hotels]) ;  
    }
