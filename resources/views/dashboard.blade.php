...
@section('content')
  ...
  <!--<form method="post" action="{{ route('getAccessToken') }}" >-->
  <!--                           @csrf-->
  <!--                           <input type="text" id="code" name="code" value>-->
  <!--                      <button type="submit"  class="btn btn-outline-success mb-2">get code access</button>-->
  <!--   </form>-->
        ...
        @if (Auth::guard()->user()->role==1)
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-two">
                    ...
                    <div class="widget-content">
                        ...
                        <input type="hidden" name="res_count_st_ck" id="res_count_st_ck" value="{{ $res_state["res_count_st_ck"] }}"/>
                        ...
                        <div class="tabs tab-content">
                            <div id="2" class="tabcontent"> 
                                ...
                                <input type="hidden" name="mois_{{$i}}_book_pur" id="mois_{{$i}}_book_pur" @if(isset($records[$i]["total_purchsing"]))  value="{{$records[$i]["total_purchsing"]}}" @else value="0"  @endif/>
                                 ...
                                 <input type="hidden" name="mois_{{$i}}_book_binding" id="mois_{{$i}}_book"  @if(isset($records_binding[$i]["total"])) value="{{$records_binding[$i]["total"]}} " @else value="0" @endif/>
                                <input type="hidden" name="mois_{{$i}}_book_pur_binding" id="mois_{{$i}}_book_pur" @if(isset($records_binding[$i]["total_purchsing"]))  value="{{$records_binding[$i]["total_purchsing"]}}" @else value="0"  @endif/>
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-three">
                    ...
                    <input type="hidden" name="mois_{{$i}}_parans_1" id="mois_{{$i}}_parans_1"  @if(isset($records_prece_1[$i]["total"])) value="{{$records_prece_1[$i]["total"]}} " @else value="0" @endif/>
                    <input type="hidden" name="mois_{{$i}}_parans_ans_pre_plus" id="mois_{{$i}}_parans_ans_pre_plus"  @if(isset($records_prece_ans_pre_plus[$i]["total"])) value="{{$records_prece_ans_pre_plus[$i]["total"]}} " @else value="0" @endif/>
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-three">
                    ...
                    <input type="hidden" name="mois_{{$i}}_parans_1_checkout" id="mois_{{$i}}_parans_1_checkout"  @if(isset($records_prece_1_checkout[$i]["total"])) value="{{$records_prece_1_checkout[$i]["total"]}} " @else value="0" @endif/>
                    <input type="hidden" name="mois_{{$i}}_parans_ans_pre_plus_checkout" id="mois_{{$i}}_parans_ans_pre_plus_checkout"  @if(isset($records_prece_ans_pre_plus_checkout[$i]["total"])) value="{{$records_prece_ans_pre_plus_checkout[$i]["total"]}} " @else value="0" @endif/>
                    <input type="hidden" name="mois_{{$i}}_parans" id="mois_{{$i}}_parans_checkout"  @if(isset($records_prece_checkout[$i]["total"])) value="{{$records_prece_checkout[$i]["total"]}} " @else value="0" @endif/>
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-three">
                    ...
                    <input type="hidden" name="mois_{{$i}}_parans_1_checkin" id="mois_{{$i}}_parans_1_checkin"  @if(isset($records_prece_1_checkin[$i]["total"])) value="{{$records_prece_1_checkin[$i]["total"]}} " @else value="0" @endif/>
                    <input type="hidden" name="mois_{{$i}}_parans_ans_pre_plus_checkin" id="mois_{{$i}}_parans_ans_pre_plus_checkin"  @if(isset($records_prece_ans_pre_plus__checkin[$i]["total"])) value="{{$records_prece_ans_pre_plus__checkin[$i]["total"]}} " @else value="0" @endif/>
                    <input type="hidden" name="mois_{{$i}}_parans_checkout" id="mois_{{$i}}_parans_checkin"  @if(isset($records_prece_checkin[$i]["total"])) value="{{$records_prece_checkin[$i]["total"]}} " @else value="0" @endif/>
