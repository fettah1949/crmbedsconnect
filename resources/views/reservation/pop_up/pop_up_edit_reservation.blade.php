            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group col-sm-auto">
                        ...
                        name="un_pr_selling_exchangeRate" id="un_pr_selling_exchangeRate{{$tgx}}" 
                        value="{{$quoteSelling_checkout}}"  onkeyup='setValue("{{$tgx}}");'>
                        @else
                        <input type="text" class="form-control"  name="un_pr_selling_exchangeRate"
                         id="un_pr_selling_exchangeRate{{$tgx}}" 
                        value="{{ $quoteSelling_booking }}"  onkeyup='setValue("{{$tgx}}");' >
                        @endif
                    </div>
                </div>
                <div class="col-sm-4">
