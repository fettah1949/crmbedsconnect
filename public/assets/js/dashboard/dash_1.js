...
//  alert($res_ok);
$res_count_st_cn=parseInt(document.getElementById("res_count_st_cn").value);
$res_count_st_ck=parseInt(document.getElementById("res_count_st_ck").value);
// alert($res_count_st_cn);
$res_count_st_KUN=parseInt(document.getElementById("res_count_st_KUN").value);
// alert($res_count_st_KUN);
$res_count_st_CN_FEE=parseInt(document.getElementById("res_count_st_CN_FEE").value);
...
$data=[$res_ok, $res_count_st_cn, $res_count_st_KUN, $res_count_st_CN_FEE,$res_count_stCN_NRF,$res_count_st_NO_SHOW,$res_count_st_ck];
// alrt($res_ok);
var options = {
    ...
    colors: ['#00FF00', '#e7515a','#5c1ac3', '#e2a03f', '#e2a03f', '#5c1ac3','#5c1ac3'],
    dataLabels: {
      enabled: false
    },
    legend: {
    ...
    series: $data,
    labels: ['OK','CN', 'KUN', 'CN FEE','CN NRF','NO SHOW','CK'],
    responsive: [{
        breakpoint: 1599,
        options: {
            chart: {
 ...
 /*
    ...
    */
        ...
        $mois_0_parans_1=parseInt(document.getElementById("mois_0_parans_1").value);

        $mois_1_parans_1=parseInt(document.getElementById("mois_1_parans_1").value);
        
        $mois_2_parans_1=parseInt(document.getElementById("mois_2_parans_1").value);
        
        $mois_3_parans_1=parseInt(document.getElementById("mois_3_parans_1").value);
        
        $mois_4_parans_1=parseInt(document.getElementById("mois_4_parans_1").value);
        
        $mois_5_parans_1=parseInt(document.getElementById("mois_5_parans_1").value);
        
        $mois_6_parans_1=parseInt(document.getElementById("mois_6_parans_1").value);
        
        $mois_7_parans_1=parseInt(document.getElementById("mois_7_parans_1").value);
        
        $mois_8_parans_1=parseInt(document.getElementById("mois_8_parans_1").value);
        
        $mois_9_parans_1=parseInt(document.getElementById("mois_9_parans_1").value);
        
        $mois_10_parans_1=parseInt(document.getElementById("mois_10_parans_1").value);
        
        $mois_11_parans_1=parseInt(document.getElementById("mois_11_parans_1").value);

        $mois_0_parans_ans_pre_plus=parseInt(document.getElementById("mois_0_parans_ans_pre_plus").value);

        $mois_1_parans_ans_pre_plus=parseInt(document.getElementById("mois_1_parans_ans_pre_plus").value);

        $mois_2_parans_ans_pre_plus=parseInt(document.getElementById("mois_2_parans_ans_pre_plus").value);

        $mois_3_parans_ans_pre_plus=parseInt(document.getElementById("mois_3_parans_ans_pre_plus").value);

        $mois_4_parans_ans_pre_plus=parseInt(document.getElementById("mois_4_parans_ans_pre_plus").value);

        $mois_5_parans_ans_pre_plus=parseInt(document.getElementById("mois_5_parans_ans_pre_plus").value);

        $mois_6_parans_ans_pre_plus=parseInt(document.getElementById("mois_6_parans_ans_pre_plus").value);

        $mois_7_parans_ans_pre_plus=parseInt(document.getElementById("mois_7_parans_ans_pre_plus").value);

        $mois_8_parans_ans_pre_plus=parseInt(document.getElementById("mois_8_parans_ans_pre_plus").value);

        $mois_9_parans_ans_pre_plus=parseInt(document.getElementById("mois_9_parans_ans_pre_plus").value);

        $mois_10_parans_ans_pre_plus=parseInt(document.getElementById("mois_10_parans_ans_pre_plus").value);

        $mois_11_parans_ans_pre_plus=parseInt(document.getElementById("mois_11_parans_ans_pre_plus").value);
        ...
        $mois_0_parans_1_checkout=parseInt(document.getElementById("mois_0_parans_1_checkout").value);

        $mois_1_parans_1_checkout=parseInt(document.getElementById("mois_1_parans_1_checkout").value);
        
        $mois_2_parans_1_checkout=parseInt(document.getElementById("mois_2_parans_1_checkout").value);
        
        $mois_3_parans_1_checkout=parseInt(document.getElementById("mois_3_parans_1_checkout").value);
        
        $mois_4_parans_1_checkout=parseInt(document.getElementById("mois_4_parans_1_checkout").value);
        
        $mois_5_parans_1_checkout=parseInt(document.getElementById("mois_5_parans_1_checkout").value);
        
        $mois_6_parans_1_checkout=parseInt(document.getElementById("mois_6_parans_1_checkout").value);
        
        $mois_7_parans_1_checkout=parseInt(document.getElementById("mois_7_parans_1_checkout").value);
        
        $mois_8_parans_1_checkout=parseInt(document.getElementById("mois_8_parans_1_checkout").value);
        
        $mois_9_parans_1_checkout=parseInt(document.getElementById("mois_9_parans_1_checkout").value);
        
        $mois_10_parans_1_checkout=parseInt(document.getElementById("mois_10_parans_1_checkout").value);
        
        $mois_11_parans_1_checkout=parseInt(document.getElementById("mois_11_parans_1_checkout").value);

        $mois_0_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_0_parans_ans_pre_plus_checkout").value);

        $mois_1_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_1_parans_ans_pre_plus_checkout").value);

        $mois_2_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_2_parans_ans_pre_plus_checkout").value);

        $mois_3_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_3_parans_ans_pre_plus_checkout").value);

        $mois_4_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_4_parans_ans_pre_plus_checkout").value);

        $mois_5_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_5_parans_ans_pre_plus_checkout").value);

        $mois_6_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_6_parans_ans_pre_plus_checkout").value);

        $mois_7_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_7_parans_ans_pre_plus_checkout").value);

        $mois_8_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_8_parans_ans_pre_plus_checkout").value);

        $mois_9_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_9_parans_ans_pre_plus_checkout").value);

        $mois_10_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_10_parans_ans_pre_plus_checkout").value);

        $mois_11_parans_ans_pre_plus_checkout=parseInt(document.getElementById("mois_11_parans_ans_pre_plus_checkout").value);
...
$mois_11_parans_checkout=parseInt(document.getElementById("mois_11_parans_checkout").value);
        ...
        $mois_0_parans_1_checkin=parseInt(document.getElementById("mois_0_parans_1_checkin").value);

        $mois_1_parans_1_checkin=parseInt(document.getElementById("mois_1_parans_1_checkin").value);
        
        $mois_2_parans_1_checkin=parseInt(document.getElementById("mois_2_parans_1_checkin").value);
        
        $mois_3_parans_1_checkin=parseInt(document.getElementById("mois_3_parans_1_checkin").value);
        
        $mois_4_parans_1_checkin=parseInt(document.getElementById("mois_4_parans_1_checkin").value);
        
        $mois_5_parans_1_checkin=parseInt(document.getElementById("mois_5_parans_1_checkin").value);
        
        $mois_6_parans_1_checkin=parseInt(document.getElementById("mois_6_parans_1_checkin").value);
        
        $mois_7_parans_1_checkin=parseInt(document.getElementById("mois_7_parans_1_checkin").value);
        
        $mois_8_parans_1_checkin=parseInt(document.getElementById("mois_8_parans_1_checkin").value);
        
        $mois_9_parans_1_checkin=parseInt(document.getElementById("mois_9_parans_1_checkin").value);
        
        $mois_10_parans_1_checkin=parseInt(document.getElementById("mois_10_parans_1_checkin").value);
        
        $mois_11_parans_1_checkin=parseInt(document.getElementById("mois_11_parans_1_checkin").value);

        $mois_0_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_0_parans_ans_pre_plus_checkin").value);

        $mois_1_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_1_parans_ans_pre_plus_checkin").value);

        $mois_2_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_2_parans_ans_pre_plus_checkin").value);

        $mois_3_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_3_parans_ans_pre_plus_checkin").value);

        $mois_4_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_4_parans_ans_pre_plus_checkin").value);

        $mois_5_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_5_parans_ans_pre_plus_checkin").value);

        $mois_6_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_6_parans_ans_pre_plus_checkin").value);

        $mois_7_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_7_parans_ans_pre_plus_checkin").value);

        $mois_8_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_8_parans_ans_pre_plus_checkin").value);

        $mois_9_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_9_parans_ans_pre_plus_checkin").value);

        $mois_10_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_10_parans_ans_pre_plus_checkin").value);

        $mois_11_parans_ans_pre_plus_checkin=parseInt(document.getElementById("mois_11_parans_ans_pre_plus_checkin").value);
